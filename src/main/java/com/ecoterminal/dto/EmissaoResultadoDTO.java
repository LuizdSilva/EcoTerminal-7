...
public class EmissaoResultadoDTO {
    ...
    public Long getEmissaoId(){ 
        return emissaoId; }
    public void setEmissaoId(Long emissaoId){ 
    ...
    public String getOnibusPrefixo(){ 
        return onibusPrefixo; }
    public void setOnibusPrefixo(String onibusPrefixo){
         this.onibusPrefixo = onibusPrefixo; }
    ...
    public double getCo2Toneladas(){ 
        return co2Toneladas; }
    public void setCo2Toneladas(double co2Toneladas){ 
        this.co2Toneladas = co2Toneladas; }

    public double getMpToneladas(){ 
        return mpToneladas; }
    public void setMpToneladas(double mpToneladas){
         this.mpToneladas = mpToneladas; }

    public double getNoxToneladas(){ 
        return noxToneladas; }
    public void setNoxToneladas(double noxToneladas){
        this.noxToneladas = noxToneladas; }

    public double getVktKmAno(){ 
        return vktKmAno; }
    public void setVktKmAno(double vktKmAno){
         this.vktKmAno = vktKmAno; }

    public double getConsumoEnergiaKwhKm(){
         return consumoEnergiaKwhKm; }
    public void setConsumoEnergiaKwhKm(double consumoEnergiaKwhKm){
         this.consumoEnergiaKwhKm = consumoEnergiaKwhKm; }

    public double getEfCo2GKwh(){
         return efCo2GKwh; }
    public void setEfCo2GKwh(double efCo2GKwh){
         this.efCo2GKwh = efCo2GKwh; }

    public double getEfMpGKm(){
         return efMpGKm; }
    public void setEfMpGKm(double efMpGKm){
         this.efMpGKm = efMpGKm; }

    public double getEfNoxGKm(){ 
        return efNoxGKm; }
    public void setEfNoxGKm(double efNoxGKm){
         this.efNoxGKm = efNoxGKm; }

    public Boolean getConformeCo2(){ 
        return conformeCo2; }
    public void setConformeCo2(Boolean conformeCo2){
         this.conformeCo2 = conformeCo2; }

    public Boolean getConformeMp(){
         return conformeMp; }
    public void setConformeMp(Boolean conformeMp){
         this.conformeMp = conformeMp; }

    public Boolean getConformeNox(){ 
        return conformeNox; }
    public void setConformeNox(Boolean conformeNox){ 
        this.conformeNox = conformeNox; }

    public Double getReducaoCo2Percentual(){
         return reducaoCo2Percentual; }
    public void setReducaoCo2Percentual(Double reducaoCo2Percentual){
         this.reducaoCo2Percentual = reducaoCo2Percentual; }
}
